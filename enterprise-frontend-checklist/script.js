document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("reset-checklist").addEventListener("click", () => {
    if (confirm("Are you sure you want to reset all checklist items? This cannot be undone.")) {
      ...
      localStorage.removeItem("frontendChecklistStates");
      localStorage.removeItem("frontendLastUpdated");
  ...
  function saveCheckboxStates() {
    ...
    localStorage.setItem("frontendChecklistStates", JSON.stringify(states));
  ...
  function loadCheckboxStates() {
    const states = JSON.parse(localStorage.getItem("frontendChecklistStates"));
    if (states) {
      document.querySelectorAll(".checkbox").forEach((checkbox, index) => {
