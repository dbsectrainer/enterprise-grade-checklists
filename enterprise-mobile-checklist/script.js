document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("reset-checklist").addEventListener("click", () => {
    if (confirm("Are you sure you want to reset all checklist items? This cannot be undone.")) {
      ...
      localStorage.removeItem("mobileChecklistStates");
      localStorage.removeItem("mobileLastUpdated");
  ...
  function saveCheckboxStates() {
    ...
    localStorage.setItem("mobileChecklistStates", JSON.stringify(states));
  ...
  function loadCheckboxStates() {
    const states = JSON.parse(localStorage.getItem("mobileChecklistStates"));
    if (states) {
      document.querySelectorAll(".checkbox").forEach((checkbox, index) => {
